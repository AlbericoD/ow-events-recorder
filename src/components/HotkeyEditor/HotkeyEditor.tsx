...
import { kKeyCodes } from '../../constants/key-codes';
...
export function HotkeyEditor({ hotkeyName }: { hotkeyName: string }) {
  ...
  return (
    <div
      className={classNames('HotkeyEditor', { editing, error })}
    ...
    >
      ...
      {/* <CSSTransition
        in={hotkeyBinding !== kHotkeyUnassignedBinding}
        classNames="clear"
        timeout={150}
      >
        <button className="clear" onClick={unassignKey} />
      </CSSTransition> */}
    </div>
  );
}
